        ...
        $("i.far").on('click', function (event) {
            ...
            $.ajax({
                ...
                success: function () {
                    ...
                    $("#" + videoId).replaceWith('<i id="' + videoId + '"' + 'class="fas fa-star fa-3x text-warning getHover"></i>');
        ...
        $("i.fas").on('click', function (event) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $("#" + videoId).replaceWith('<i id="' + videoId + '"' + 'class="far fa-star fa-3x text-warning getHover"></i>');
